<template>
	<div :class="{'d-none': !(active == 'kecamatan')}">
		...
		<div style="text-align: left;background-color: #FFF;">
			<table class="table table-bordered table-striped" id="table-kecamatan">
				<thead style="background-color: #eee138;">
					<tr class="sort-table">
						<th>#</th>
						<th @click="sortTable(1)">Kecamatan</th>
...
export default {
	...
	methods: {
		async loadData(){
			...
			let response = await fetch(this.apiUrl + 'api/get-all-kecamatan'+param)
